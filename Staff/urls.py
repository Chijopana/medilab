...
urlpatterns = [
    ...
    path('editar_perfil/', views.editar_perfil_medico, name='staff/editar_perfil'),

    path('prueba/<uuid:access_key>/', views.prueba, name='staff/prueba2'),

    path('paciente/visitas/<uuid:access_key>/', views.visitas, name='staff/visitas'),
    path('paciente/expedientes/<uuid:access_key>/', views.expedientes, name='staff/expedientes'),
    path('paciente/medicacion/<uuid:access_key>/', views.medicacion, name='staff/medicacion'),
]
